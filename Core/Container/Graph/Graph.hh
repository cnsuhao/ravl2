...
namespace RavlN {
  ...
  template<class NodeT,class EdgeT>
  GraphC<NodeT,EdgeT> 
  GraphC<NodeT,EdgeT>::Copy(HashC<GraphNodeIterC<NodeT,EdgeT>,GraphNodeIterC<NodeT,EdgeT> > &NodeMap) {
  ...
  GraphC<NodeT,EdgeT>::InsNode(const NodeT &dat)  {
    return GraphNodeIterC<NodeT,EdgeT>(
				       GraphBaseC::InsNode(
							   *new GraphNodeDatC<NodeT,EdgeT>(Body(),
											   dat,
											   AllocNodeID()
											   )));
  }
  ...
  GraphC<NodeT,EdgeT>::InsEdge(GraphNodeIterC<NodeT,EdgeT> &fromNode,
				GraphNodeIterC<NodeT,EdgeT> & toNode,
				const EdgeT &Dat) {
    return GraphEdgeIterC<NodeT,EdgeT>(
				       GraphBaseC::InsEdge(
							   *new GraphEdgeDatC<EdgeT>(fromNode.NodeRep(),
										     toNode.NodeRep(),
										     Dat,
										     AllocEdgeID())));
  }
  ...
  inline 
  GraphEdgeIterC<NodeT,EdgeT> 
  GraphC<NodeT,EdgeT>::InsEdge(const GraphNodeHC<NodeT,EdgeT> &fromNode, 
				const GraphNodeHC<NodeT,EdgeT> &toNode,
				const EdgeT &Dat
				) {
    return GraphEdgeIterC<NodeT,EdgeT>(
