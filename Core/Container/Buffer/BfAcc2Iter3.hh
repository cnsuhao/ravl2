...
namespace RavlN {
  ...
  template <class Data1C,class Data2C,class Data3C>
  ...
  public:
    ...
    BufferAccess2dIter3C(const SizeBufferAccessC<BufferAccessC<Data1C> > &pbuf1,SizeT size1,
    ...
    BufferAccess2dIter3C(const RangeBufferAccessC<BufferAccessC<Data1C> > &pbuf1,const IndexRangeC &nrng1,
  ...
  protected:
    BufferAccessIter3C<BufferAccessC<Data1C>,BufferAccessC<Data2C>,BufferAccessC<Data3C> > rit;
    BufferAccessIter3C<Data1C,Data2C,Data3C> cit;
    IndexRangeC rng1;
    IndexRangeC rng2;
    IndexRangeC rng3;
  };
