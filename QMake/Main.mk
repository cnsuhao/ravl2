...
INCLUDES := -I$(INST_INCLUDE)/$(ARC) -I$(INST_INCLUDE) $(INCLUDES)

ifdef EXTPACKAGE
 INCLUDES += -I$(PROJECT_OUT)\inc\$(PACKAGE)
endif

CINCLUDES = -I$(INST_HEADER) $(INCLUDES)

ifdef LIBDEPS
LIBS += -L$(INST_LIB) $(EXELIB) 
BINLIBS += -L$(INST_LIB) $(LINKLIBS) 
else
LIBS += $(OPTLIBPATH) -L$(INST_LIB) $(OPTLIB) $(EXELIB) 
BINLIBS += $(OPTLIBPATH) -L$(INST_LIB) $(OPTLIB) $(LINKLIBS)
endif
