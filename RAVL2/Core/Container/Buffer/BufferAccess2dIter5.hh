...
///////////////////////////////////////////////////////////
//! rcsid="$Id$"
//! file="Ravl/Core/Container/Buffer/BufferAccess2dIter5.hh"
//! lib=RavlCore
...
namespace RavlN {
  ...
  public:
    ...
    BufferAccess2dIter5C(const BufferAccessC<Data1T> &pbuf1,IntT stride1,
    ...
    BufferAccess2dIter5C(const BufferAccessC<Data1T> &pbuf1,IntT byteStride1,
    ...
    BufferAccess2dIter5C(const BufferAccessC<Data1T> &pbuf1,IntT byteStride1,const IndexRange2dC &range1,
    ...
    BufferAccess2dIter5C(const BufferAccessC<Data1T> &pbufA,IntT byteStrideA,const IndexRangeC &nrng1a,const IndexRangeC &nrng2a,
  ...
  protected:
    BufferAccessIter5C<Data1T,Data2T,Data3T,Data4T,Data5T> m_cit;
    SizeT m_size2;
  ...
  template <class Data1T,class Data2T,class Data3T,class Data4T,class Data5T>
  bool BufferAccess2dIter5C<Data1T,Data2T,Data3T,Data4T,Data5T>::CNextRow() {
    m_rit1 += m_stride1;
    m_rit2 += m_stride2;
    m_rit3 += m_stride3;
    m_rit4 += m_stride4;
