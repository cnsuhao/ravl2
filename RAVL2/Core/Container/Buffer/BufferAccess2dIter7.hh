...
namespace RavlN {
  ...
  public:
    ...
    BufferAccess2dIter7C(const BufferAccessC<Data1T> &pbuf1,IntT stride1,
			 ...
			 const BufferAccessC<Data7T> &pbuf7,IntT stride7,
    ...
    BufferAccess2dIter7C(const BufferAccessC<Data1T> &pbuf1,IntT byteStride1,
                         ...
                         const BufferAccessC<Data7T> &pbuf7,IntT byteStride7,
    ...
    BufferAccess2dIter7C(const BufferAccessC<Data1T> &pbuf1,IntT byteStride1,const IndexRange2dC &range1,
			 const BufferAccessC<Data2T> &pbuf2,IntT byteStride2,const IndexRange2dC &range2,
                         ...
                         const BufferAccessC<Data7T> &pbuf7,IntT byteStride7,const IndexRange2dC &range7
                         )
    { First(pbuf1,byteStride1,range1.Range1(),range1.Range2(),
            ...
            pbuf7,byteStride7,range7.Range1(),range7.Range2()
           );
    }
    //: Constructor.

    BufferAccess2dIter7C(const BufferAccessC<Data1T> &pbufA,IntT byteStrideA,const IndexRangeC &nrng1a,const IndexRangeC &nrng2a,
			 const BufferAccessC<Data2T> &pbufB,IntT byteStrideB,const IndexRangeC &nrng1b,const IndexRangeC &nrng2b,
                         ...
                         const BufferAccessC<Data7T> &pbufG,IntT byteStrideG,const IndexRangeC &nrng1g,const IndexRangeC &nrng2g
                        )
    { First(pbufA,byteStrideA,nrng1a,nrng2a,
	    pbufB,byteStrideB,nrng1b,nrng2b,
            ...
            pbufG,byteStrideG,nrng1g,nrng2g
           );
    }
    //: Constructor.
    ...
    bool RowStart() {
      return m_cit.First(reinterpret_cast<Data1T*>(m_rit1),
                         ...
                         reinterpret_cast<Data7T*>(m_rit7),
                         m_size2);
    }
  ...
  public:
    bool First(const BufferAccessC<Data1T> &pbuf1,IntT byteStride1,
      ...
      m_rit7 = reinterpret_cast<char *>(pbuf7.ReferenceElm());
    ...
    bool First(const Data1T *pbuf1,
      ...
      m_rit7   = reinterpret_cast<char *>(const_cast<Data7T*>(pbuf7));
    ...
    bool First(const BufferAccessC<Data1T> &pbuf1,IntT byteStride1,
      ...
      m_rit7 = reinterpret_cast<char *>(pbuf7.ReferenceElm() + range2.Min().V()) + byteStride7 * range1.Min().V();
    ...
    bool First(const BufferAccessC<Data1T> &pbufa,IntT byteStrideA,const IndexRangeC &range1a,const IndexRangeC &range2a,
	       ...
	       const BufferAccessC<Data4T> &pbufd,IntT byteStrideD,const IndexRangeC &range1d,const IndexRangeC &range2d,
 	       ...
 	       const BufferAccessC<Data7T> &pbufg,IntT byteStrideG,const IndexRangeC &range1g,const IndexRangeC &range2g
              ) {
      ...
      RavlAssert(range1a.Size() >= range1g.Size());
      ...
      m_rit7 = reinterpret_cast<char *>(pbufg.ReferenceElm() + range2g.Min().V()) + byteStrideG * range1g.Min().V();
    ...
    bool First(const BufferAccessC<Data1T> &pbufa,IntT byteStrideA,const IndexRange2dC &rangea,
	       ...
	       const BufferAccessC<Data7T> &pbufg,IntT byteStrideG,const IndexRange2dC &rangeg
               ) {
      return First(pbufa,byteStrideA,rangea.Range1(),rangea.Range2(),
                   ...
                   pbufg,byteStrideG,rangeg.Range1(),rangeg.Range2()
                  );
    }
    //: Goto first element.
    // returns true if there is one.
    ...
    bool NextRow(IntT offset) {
      ...
      m_cit.First(reinterpret_cast<Data1T*>(m_rit1) + offset,
                  ...
                  reinterpret_cast<Data7T*>(m_rit7) + offset,
                  m_size2 - offset);
      return true;
    }
  ...
  protected:
    BufferAccessIter7C<Data1T,Data2T,Data3T,Data4T,Data5T,Data6T,Data7T> m_cit;
    SizeT m_size2;
  ...
  template <class Data1T,class Data2T,class Data3T,class Data4T,class Data5T,class Data6T,class Data7T>
  bool BufferAccess2dIter7C<Data1T,Data2T,Data3T,Data4T,Data5T,Data6T,Data7T>::CNextRow() {
    m_rit1 += m_stride1;
    m_rit2 += m_stride2;
    m_rit3 += m_stride3;
    m_rit4 += m_stride4;
