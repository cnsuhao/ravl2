...
namespace RavlN {
  ...
  public:
    ...
    inline bool First() {
      return BufferAccess2dIter7C<Data1T,Data2T,Data3T,Data4T,Data5T,Data6T,Data7T>::First(dat1.BufferAccess(),dat1.ByteStride(),dat1.Frame(),
								             ...
								             dat6.BufferAccess(),dat6.ByteStride(),dat6.Frame(),
 								             dat7.BufferAccess(),dat7.ByteStride(),dat7.Frame()
                                                                             );
    }
