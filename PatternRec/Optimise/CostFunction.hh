...
//! userlevel=Normal
//! example=testCost.cc
//! file="Ravl/PatternRec/FuncTools/Cost/NumCostFunction.hh"
//! docentry="Optimisation.Cost Functions.Implementation;Numerical Methods.Optimisation.Cost Functions.Implementation"
//! rcsid="$Id$"
