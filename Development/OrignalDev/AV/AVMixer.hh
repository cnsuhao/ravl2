...
namespace RavlImageN {
  ...
  //! userlevel=Develop
  //: Mix Audio and Video data into an AVFrame. Audio is synchronised to video and handles seperate image and audio streams
  ...
  public:
    ...
    virtual void VideoFlag(bool flag){haveVideo=flag;}
    //: Set video flag
    
    virtual void AudioFlag(bool flag){haveAudio=flag;}
    //: Set audio flag
  ...
  protected:    
    ...
    bool haveVideo;
    bool haveAudio;
    SArray1dC<SampleElemC<2,Int16T> > dummyAudioFrame;
    ImageC<ByteRGBValueC> dummyVideoFrame;
  };
