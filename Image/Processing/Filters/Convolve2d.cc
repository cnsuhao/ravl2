...
//! rcsid="$Id$"
//! lib=RavlImage
//! file="Ravl/Image/Processing/Filters/Convolve2d.cc"
...
namespace RavlImageN {
  ...
  static void ShortConvolve2d(const ImageC<short> &in,ImageC<short> &result,const ImageC<short> &kernel) {
    ONDEBUG(cerr << "ShortConvolve2d(), Using MMX functions. \n");
  ...
  void Convolve2dC<short,short,short,short>::Apply(const ImageC<short> &in,ImageC<short> &result) const {
