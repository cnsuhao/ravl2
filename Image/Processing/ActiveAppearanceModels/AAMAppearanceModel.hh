...
namespace RavlImageN {
  ...
  public:
    ...
    bool Design(const DListC<StringC> &fileList,const StringC &dir,const StringC &mirrorFile,const Index2dC &maskSize,const RealT varS = 0.95,const RealT varT = 0.95,const RealT varC = 0.95,const UIntT maxS=25,const UIntT maxT=120,const UIntT maxC=80);
    ...
    void MakePlausible(VectorC &parm) const;
  ...
  public:
    ...
    void MakePlausible(VectorC &parm) const
    { return Body().MakePlausible(parm); }
    //: Constrains parm to be plausible by applying hard limits of 3 std to each element
