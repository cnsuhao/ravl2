...
void init_destination (j_compress_ptr cinfo) {
  amma_destination_mgr *dest = (amma_destination_mgr *) cinfo->dest;
...
void  init_source (j_decompress_ptr cinfo) {
  amma_source_mgr *src = (amma_source_mgr *) cinfo->src;
...
BooleanT DPImageIOJPegIBaseC::SetupFormat(const type_info &ti) {
...
BooleanT DPImageIOJPegOBaseC::SetupFormat(const type_info &ti) {
...
DPIImageJPegByteRGBC::DPIImageJPegByteRGBC(FilenameC fn)
...
DPOImageJPegByteRGBC::DPOImageJPegByteRGBC(FilenameC fn,int compression)
...
DPIImageJPegByteYUVC::DPIImageJPegByteYUVC(FilenameC fn)
...
DPOImageJPegByteYUVC::DPOImageJPegByteYUVC(FilenameC fn,int compression)
...
DPIImageJPegByteGreyC::DPIImageJPegByteGreyC(FilenameC fn)
  : DPEntityC(*new DPIImageJPegBodyC<ByteGreyValueT>(fn))
{}
...
DPIImageJPegByteGreyC::DPIImageJPegByteGreyC(const IStreamC &strm)
  : DPEntityC(*new DPIImageJPegBodyC<ByteGreyValueT>(strm))
{}
...
DPOImageJPegByteGreyC::DPOImageJPegByteGreyC(FilenameC fn,int compression)
  : DPEntityC(*new DPOImageJPegBodyC<ByteGreyValueT>(fn,compression))
{}
...
DPOImageJPegByteGreyC::DPOImageJPegByteGreyC(const OStreamC &strm,int compression)
  : DPEntityC(*new DPOImageJPegBodyC<ByteGreyValueT>(strm,compression))
{}
