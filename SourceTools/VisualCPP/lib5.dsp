...
# ADD LIB32 /nologo /out:"$(VCPP_SRC_ROOT)/$(PROJECT_NAME).lib"
...
# ADD CPP /nologo /MTd /W3 /GR /GX /Z7 /Od  /I "$(VCPP_SRC_ROOT)/inc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "VISUAL_CPP" /YX /FD /c
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LIB32=link.exe -lib
